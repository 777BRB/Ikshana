 ...
 const Upload = () => {
  ...
  return (
    ...
    <section className='middle' style={{position:"relative", height:"400px", top:"90px", width:"1200px", margin:"auto", borderRadius:"10px", background: "linear-gradient(aqua,orange)"}}>
          ...
          <h2 style={{position:"relative", top:"100px", left:"-50px", fontSize:"16px"}}>Upload image here!</h2>
          ...
          <h2 style={{position:"relative", top:"100px", left:"-60px", fontSize:"16px", display:"block"}}>Enter Co-ordinates here!!</h2>
